...
/* Private defines -----------------------------------------------------------*/
#define GPIO10_Pin GPIO_PIN_13
#define GPIO10_GPIO_Port GPIOC
#define GPIO11_Pin GPIO_PIN_14
#define GPIO11_GPIO_Port GPIOC
#define GPIO12_Pin GPIO_PIN_15
...
#define GPIO13_Pin GPIO_PIN_6
#define GPIO13_GPIO_Port GPIOA
#define GPIO14_Pin GPIO_PIN_7
#define GPIO14_GPIO_Port GPIOA
#define GPIO15__Pin GPIO_PIN_4
#define GPIO15__GPIO_Port GPIOC
#define GPIO16__Pin GPIO_PIN_5
#define GPIO16__GPIO_Port GPIOC
#define GPIO17__Pin GPIO_PIN_0
#define GPIO17__GPIO_Port GPIOB
#define GPIO18__Pin GPIO_PIN_1
#define GPIO18__GPIO_Port GPIOB
#define BOOT1_Pin GPIO_PIN_2
#define BOOT1_GPIO_Port GPIOB
#define TX1_Pin GPIO_PIN_10
#define TX1_GPIO_Port GPIOB
#define RX1_Pin GPIO_PIN_11
#define RX1_GPIO_Port GPIOB
#define GPIO19__Pin GPIO_PIN_12
#define GPIO19__GPIO_Port GPIOB
#define GPIO20__Pin GPIO_PIN_13
...
#define FTDI_RTS_Pin GPIO_PIN_11
#define FTDI_RTS_GPIO_Port GPIOA
#define FTDI_CTS_Pin GPIO_PIN_12
#define FTDI_CTS_GPIO_Port GPIOA
#define SWDIO_Pin GPIO_PIN_13
#define SWDIO_GPIO_Port GPIOA
#define SWCLK_Pin GPIO_PIN_14
#define SWCLK_GPIO_Port GPIOA
#define GPIO6_Pin GPIO_PIN_15
